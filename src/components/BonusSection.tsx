    ...
    <section className="py-8 md:py-16 bg-secondary">
      <div className="container mx-auto px-3 md:px-4">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-6 order-2 md:order-1">
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div 
                    key={index}
                    className="bg-background p-4 md:p-6 rounded-xl text-center hover:shadow-md transition-shadow duration-300"
                  >
                    <Icon className="w-8 h-8 md:w-10 md:h-10 mx-auto mb-2 md:mb-3 text-primary" />
          ...
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-6 md:p-12 rounded-xl md:rounded-2xl border-2 border-primary/20">
            <div className="text-center mb-6 md:mb-8">
              <Gift className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 text-primary" />
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-6">
              {bonuses.map((bonus, index) => {
                ...
                return (
                  <div 
                    key={index}
                    className="bg-background p-4 md:p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300"
                  >
                    <Icon className="w-10 h-10 md:w-12 md:h-12 mb-3 md:mb-4 text-primary" />
                    <h4 className="font-heading text-base md:text-lg font-bold text-primary mb-2">
                      {bonus.title}
                    </h4>
                    <p className="font-body text-xs md:text-base text-foreground">
                      {bonus.description}
                    </p>
                  </div>
                );
