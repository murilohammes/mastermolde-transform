    ...
    <section className="py-10 md:py-20 bg-card">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="font-body text-sm md:text-base text-center text-muted-foreground mb-10">
          ...
          <div className="relative max-w-3xl mx-auto">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl border border-border">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-background/90 backdrop-blur-sm p-3 md:p-4 border-t border-border">
                <p className="font-body text-xs md:text-sm font-medium text-foreground text-center">
              ...
              <Button
                variant="secondary"
                size="icon"
                className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 rounded-full shadow-lg w-9 h-9 md:w-10 md:h-10 border-border hover:border-primary hover:bg-primary/10"
              ...
              <Button
                variant="secondary"
                size="icon"
                className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 rounded-full shadow-lg w-9 h-9 md:w-10 md:h-10 border-border hover:border-primary hover:bg-primary/10"
                onClick={goToNext}
              >
                ...
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all ${
                    index === currentIndex 
                      ...
                      : "w-1.5 bg-muted-foreground/40 hover:bg-primary/50"
                  }`}
