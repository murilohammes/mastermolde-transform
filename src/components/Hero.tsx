    ...
    <section className="relative bg-background py-8 md:py-16 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-3 md:px-4">
        <div className="text-center mb-4">
          <h1 className="font-heading text-3xl md:text-5xl lg:text-6xl font-bold text-primary mb-2 tracking-tight">
            MASTER MOLDE
          </h1>
        </div>

        <div className="max-w-4xl mx-auto text-center space-y-3 mb-6 animate-fade-in">
        ...
        <div className="max-w-2xl mx-auto text-center space-y-3">
          ...
          <p className="text-xs md:text-sm text-muted-foreground font-body px-2">
